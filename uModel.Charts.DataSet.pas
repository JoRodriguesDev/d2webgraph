...
function TModelChartDataSet.AddChartData(ALabel: string; AValue: Variant; ABackgroundColor, ABorderColor: EnumColors; APointBackgroundColor: EnumColors = None; APointBorderColor: EnumColors = None; APointHoverBackgroundColor: EnumColors = None; APointHoverBorderColor: EnumColors = None): iModelChartDataSet;
begin
  Result := Self;
